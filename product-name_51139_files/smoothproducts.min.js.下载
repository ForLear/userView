            ...
            a(".sp-loading").hide(), a(".sp-wrap").each(function () {
                ...
                if (b > 1) {
                    ...
                    a(this).append('<div class="sp-large"></div><div class="sp-thumbs sp-tb-active"></div>'), a("a", this).each(function (index) {
                        try {
                            var arr = ['./product-name_51139_files/c7-1.jpg', './product-name_51139_files/c1-6.jpg', './product-name_51139_files/c2-5.jpg', './product-name_51139_files/20170414120434723472.bmp']
                            var ff = arr[index]
                            var gg = arr[index]
                        } catch(err) {
                            console.log(err)
