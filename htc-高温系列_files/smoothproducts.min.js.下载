        ...
        smoothproducts: function () {
            ...
            a(".sp-loading").hide(), a(".sp-wrap").each(function () {
                ...
                if (b > 1) {
                    ...
                    a(this).append('<div class="sp-large"></div><div class="sp-thumbs sp-tb-active"></div>'), a("a", this).each(function (index) {
                        try {
                            var arr = ['./product-name_files/c1-6.jpg', './product-name_files/c1-6.jpg', './product-name_files/c2-5.jpg', './product-name_files/c7-2.jpg']
                            var ff = arr[index]
                            var gg = arr[index]
                        } catch(err) {
                            console.log(err)
                        ...
                        var f = a("img", this).attr("src"),
                            ...
                            g ? g : g = gg;
                            f ? f : f = ff;
                            // if(index === 3) g = './product-name_files/c7-2.jpg';
                            // if(index === 3) f = './product-name_files/c7-2.jpg';
                        (0 === index && !e || a(this).hasClass("sp-default")) && (h = ' class="sp-current"', c = g, d = a("img", this)[index].src)
